...
notebook3 = Notebook.create(title: "Best places to read", user_id: user1.id, starred: true, default: true, trashed: false)
notebook4 = Notebook.create(title: "Drumstrang", user_id: user1.id, starred: true, default: true, trashed: false)
...
note4 = Note.create(heading: "N.E.W.T.S.", body: "It's almost Christmas!", notebook_id: notebook2.id, author_id: user1.id, starred: false, trashed: false)
note4 = Note.create(heading: "N.E.W.T.S.", body: "Here are my favorite places.", notebook_id: notebook3.id, author_id: user1.id, starred: false, trashed: false)
